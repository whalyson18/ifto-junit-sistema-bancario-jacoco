...
image::relatorio.png[]
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/whalyson18/ifto-junit-sistema-bancario-jacoco/ifto-maven[GitHub Workflow Status]
